...
public partial class PolygonTriangulator
{
    ...
    {
        var splits = ScanSplitByTrapezoidation.BuildSplits(polygon);
        var polygonWithMonotones = Polygon.Split(polygon, splits, collector);
    ...
    {
        return ScanSplitByTrapezoidation.BuildSplits(polygon);
    }
    ...
    {
        return ScanSplitByTrapezoidation.GetEdgesAfterPartialTrapezoidation(polygon, depth);
    }
}